...
public class Apresentacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Jorge Metri Miranda");

        jLabel8.setText("Lázaro José Pedrosa dos Reis");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (Integer.parseInt(opcao.getText())==1){
            try {
                valor = ConverteMoedaDouble(ValorFatura.getText());
                ...
                play.audio_descricao(1, PathAudios); //Executta o áudio inicial de cada opção
        ...
        if (Integer.parseInt(opcao.getText())==2){
            try {
                valor = ConverteMoedaDouble(Limite.getText());
                /* As cinco linhas a seguir tem o propósito de obter:
                a parte inteira, decimal e tamanho da variável valor do tipo double */
                int parte_inteira = ObtemInteiro(valor);
                int centavos = ObtemDecimais(valor);
                ...
                AudioValores play = new AudioValores(); // Define o objeto da Classe AudioValores
                int tamanho=play.calculaTamanho(valor); // Pega quantidade de dígitos da parte inteira
                play.audio_descricao(2, PathAudios); //Executta o áudio inicial de cada opção
        ...
        if (Integer.parseInt(opcao.getText())==3){
            try {
                valor = ConverteMoedaDouble(Disponivel.getText());
                /* As cinco linhas a seguir tem o propósito de obter:
                a parte inteira, decimal e tamanho da variável valor do tipo double */
                int parte_inteira = ObtemInteiro(valor);
                int centavos = ObtemDecimais(valor);
                ...
                AudioValores play = new AudioValores(); // Define o objeto da Classe AudioValores
                int tamanho=play.calculaTamanho(valor); // Pega quantidade de dígitos da parte inteira
                play.audio_descricao(3, PathAudios); //Executta o áudio inicial de cada opção
